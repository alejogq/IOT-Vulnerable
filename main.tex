...
\doctype{Report 2026}
\title{Report: Vulnerable populations and IOT}
...
\affil[a]{University of Louisville}
...
\begin{abstract}
As the implementation of IoT has expanded across many of our daily activities and tasks, the question of how vulnerable some populations are in this context arises alongside concerns about possible ways to prevent damage or improve access to these technologies, depending on the situation. 
\end{abstract}

%----------------------------------------------------------

\keywords{Internet of Things, IOT, Vulnerable populations, Kids, Elderly, United Nations Sustainable Development Goals }
...
\rhostart{T}he Internet has changed drastically the way we live, moving interactions between people at a virtual level in several contexts spanning from the professional life to social relationships. The IoT has the potential to add a new dimension to this process by enabling communications with and among smart objects, thus leading to the vision of ‘‘anytime, anywhere, anymedia, anything” communications \cite{atzori_internet_2010}.

Currently the internet scope has grown in complexity due to the increasingly number of devices that are connected to the network. 


\section{IoT, AI, and Privacy: Protecting Vulnerable Populations}

\section{Digital Surveillance of Activists and Minorities: Privacy Risks from IoT and AI}

\section{AI, IoT, and Social Media Privacy: Impacts on People with Mental Disorders and Disabilities}
